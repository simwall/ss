...
pre_install(){
    ...
    read -p "(Default password: heystop_01~):" shadowsockspwd
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="heystop_01~"
    echo
    echo "---------------------------"
    ...
    read -p "(Default port: 56743):" shadowsocksport
    [ -z "${shadowsocksport}" ] && shadowsocksport="56743"
